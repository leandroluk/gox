...
## Key Differences
- **Missing vs Null**: In `validate`, `missing` (not provided) and `null` (explicit null) are distinct states. By default, both pass unless `.Required()` is used.
...
| Tag (validator.v10) | Equivalent in `validate`        | Notes                                                                    |
| ------------------- | ------------------------------- | ------------------------------------------------------------------------ |
...
| Tag              | Equivalent in `validate` (Text) | Example                                     |
| ---------------- | ------------------------------- | ------------------------------------------- |
...
In `validate`, you handle these via:
